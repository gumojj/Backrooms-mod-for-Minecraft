...
public class EXITBlock extends Block {
	...
	public EXITBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.STONE).strength(-1, 3600000).lightLevel(s -> 7).noOcclusion().isRedstoneConductor((bs, br, bp) -> false));

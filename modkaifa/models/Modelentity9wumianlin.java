...
public static class Modelentity9wumianlin extends EntityModel<Entity> {
	...
	public Modelentity9wumianlin() {
		...
		b.setTextureOffset(16, 16).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 12.0F, 4.0F, 0.0F, false);

		la = new ModelRenderer(this);
		la.setRotationPoint(6.0F, 0.0F, 2.0F);
		la.setTextureOffset(40, 16).addBox(-14.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		ra = new ModelRenderer(this);
		ra.setRotationPoint(-6.0F, 0.0F, 2.0F);
		ra.setTextureOffset(32, 48).addBox(10.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		ll = new ModelRenderer(this);
		ll.setRotationPoint(2.0F, 12.0F, 2.0F);
		ll.setTextureOffset(16, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

		rl = new ModelRenderer(this);
		rl.setRotationPoint(-2.0F, 12.0F, 2.0F);
		rl.setTextureOffset(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
	}

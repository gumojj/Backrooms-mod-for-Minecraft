...
import net.mcreator.backrooms.procedures.Tolevel7Procedure;

public class Spblock1Block extends Block {
	public Spblock1Block() {
	...
	public void stepOn(Level world, BlockPos pos, BlockState blockstate, Entity entity) {
		...
		Tolevel7Procedure.execute(entity);
	}
}

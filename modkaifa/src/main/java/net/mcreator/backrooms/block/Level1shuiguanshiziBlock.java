...
public class Level1shuiguanshiziBlock extends Block {
	public static final DirectionProperty FACING = DirectionalBlock.FACING;

	public Level1shuiguanshiziBlock() {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			...
			case NORTH -> box(0, 6, 0, 16, 16, 16);
			case EAST -> box(0, 6, 0, 16, 16, 16);
			case WEST -> box(0, 6, 0, 16, 16, 16);
			case UP -> box(0, 0, 6, 16, 16, 16);
			case DOWN -> box(0, 0, 0, 16, 16, 10);
		};
	}

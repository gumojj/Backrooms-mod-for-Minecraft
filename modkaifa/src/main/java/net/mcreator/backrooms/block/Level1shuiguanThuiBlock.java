...
public class Level1shuiguanThuiBlock extends Block {
	public static final DirectionProperty FACING = DirectionalBlock.FACING;

	public Level1shuiguanThuiBlock() {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			default -> box(0, 6, 4, 16, 16, 16);
			case NORTH -> box(0, 6, 0, 16, 16, 12);
			case EAST -> box(4, 6, 0, 16, 16, 16);
			case WEST -> box(0, 6, 0, 12, 16, 16);
			case UP -> box(0, 4, 6, 16, 16, 16);
			case DOWN -> box(0, 0, 0, 16, 12, 10);
		};
	}

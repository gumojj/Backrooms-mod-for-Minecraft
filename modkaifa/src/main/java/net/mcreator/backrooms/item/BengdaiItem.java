...
import net.mcreator.backrooms.procedures.BengdaiDangShiWuBeiChiShiProcedure;
import net.mcreator.backrooms.init.BackroomsModItems;

public class BengdaiItem extends Item {
	public BengdaiItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		BengdaiDangShiWuBeiChiShiProcedure.execute(entity);

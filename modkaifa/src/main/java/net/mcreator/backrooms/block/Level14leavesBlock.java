...
public class Level14leavesBlock extends Block {
	public Level14leavesBlock() {
		super(BlockBehaviour.Properties.of().sound(SoundType.GRASS).strength(-1, 3600000).lightLevel(s -> 4));
	}

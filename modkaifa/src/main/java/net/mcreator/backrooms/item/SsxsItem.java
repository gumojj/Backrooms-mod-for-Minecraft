...
import net.mcreator.backrooms.procedures.SsxsDangShiWuBeiChiShiProcedure;
import net.mcreator.backrooms.init.BackroomsModItems;

public class SsxsItem extends Item {
	public SsxsItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		ItemStack retval = new ItemStack(BackroomsModItems.ZHENGGUANEMPTY.get());
		super.finishUsingItem(itemstack, world, entity);
		double x = entity.getX();
		double y = entity.getY();
		double z = entity.getZ();
		SsxsDangShiWuBeiChiShiProcedure.execute(entity);

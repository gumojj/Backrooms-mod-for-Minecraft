...
public class Entity3smilerEntity extends Monster {
	public Entity3smilerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BackroomsModEntities.ENTITY_3SMILER.get(), world);
	}

	public Entity3smilerEntity(EntityType<Entity3smilerEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(BackroomsModEntities.ENTITY_3SMILER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
